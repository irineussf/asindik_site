...
<html lang="pt-br">
    ...
    <style type="text/css">
        ...
        df-messenger {
            ...
            --df-messenger-bot-message: #ededed;
            --df-messenger-button-titlebar-color: #590006;
            --df-messenger-chat-background-color: #fafafa;
            --df-messenger-font-color: #000000;
            --df-messenger-send-icon: #878fac;
            --df-messenger-user-message: #8bff7d;
        }       
    ...
    <div class="container">
        <div class="row justify-content-center p-2">
            ...
            <?php
                ...
                echo '<div class="d-flex justify-content-center col-10 col-sm-10 col-md-5 col-xl-4 text-center m-2 b_servicos">';
        ...
        <div class="section" id="clientes" style="color= #590006;">
            ...
            <!-- coonfigurar colunas dos clientes -->
               ...
               $sql = mysqli_query($cx, "SELECT * FROM tb_clientes") or die( 
                    ...
                    while($aux = mysqli_fetch_assoc($sql)) { 
                        ...
                        echo ' <div class="col p-0">';
                            ...
                            echo '<div class="card shadow bg-white m-2">';

                                echo '<img class="card-img-top img-fluid" src="img/portfolio/'.$aux["url_img"].'">';

                                echo '<div class="card-body p-2">'/*card body open*/;
                                    echo '<h4 class="card-title">'.$aux["nome"].'</h4>';
                                    echo '<h6 class="card-subtitle text-muted">'.$aux["cidade"].'</h6>';

                                    echo '<hr class="my-1 my-3" style="background-color: #560006"/>';

                                        if ($aux["n_conjunto"] <> 0){/*dados open*/
                                            echo '<h5><p class="badge badge-dark">'.$aux["n_conjunto"].'</p> - '.$aux["t_conjunto"].' </h5>';
                                        }
                                        if ($aux["n_unidades"] <> 0){
                                            echo '<h5><p class="badge badge-dark">'.$aux["n_unidades"].'</p> - '.$aux["t_unidades"].' </h5>';
                                        }/*dados close*/

                                    echo '<p class="card-text card-footer text-center">'.$aux["p_adm"].'</p>';
              ...
              <!-- <div class="row">
                ...
                <div class="vl"></div>
                        ...
                        <div class="contact_deck" id="contact_deck">
                         ...
                         <!-- CHAT DIALOG FLOW -->
                        <div class="asindik_bot">
                        <script src="https://www.gstatic.com/dialogflow-console/fast/messenger/bootstrap.js?v=1"></script>
                            <df-messenger
                                chat-icon="img/001_logo_navbar4.svg"
                                chat-title="AsindiK"
                                agent-id="e2891e60-3cc6-4c3d-a50a-39ac7b423066"
